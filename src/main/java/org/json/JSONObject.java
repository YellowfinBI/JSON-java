...
public class JSONObject {
     ...
     *            If a key in the map is <code>null</code>
     */
    public JSONObject(Map<?, ?> m, boolean includeNullValues) {
        if (m == null) {
            this.map = new HashMap<String, Object>();
        } else {
     ...
     *            a JSONObject.
     * @param includeNullValues
     *            If set to false, any properties in the bean that have null values
     *            will not have corresponding keys created in the JSONObject.
     */
...
// Shave off trailing zeros and decimal point, if possible.
    ...
    private void populateMap(Object bean, boolean includeNullValues) {
        populateMap(bean, Collections.newSetFromMap(new IdentityHashMap<Object, Boolean>()), includeNullValues);
    }

    private void populateMap(Object bean, Set<Object> objectsRecord) {
        populateMap(bean, objectsRecord, false);
    }

    private void populateMap(Object bean, Set<Object> objectsRecord, boolean includeNullValues) {
